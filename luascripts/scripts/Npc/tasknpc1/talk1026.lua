...
function CreatureNpcFun1026(npc,event,player,funid)
  if funid == 2 and player:get_task_state(26) == 1 then
	  player:set_task_state(26,2);
      player:set_task_state(27,1);  
      player:push_task_data(27,1);
      player:add_exp(600000);
      player:add_gamemoney_bind(65000);
      return;
  end
end
