...
function CreatureNpcFun1015(npc,event,player,funid)
  if funid == 2 and player:get_task_state(14) == 1 then
	  player:set_task_state(14,2);
      player:set_task_state(15,1);  
      player:push_task_data(15,1);
      player:add_exp(50000);
      player:add_gamemoney_bind(15000);
     return;
  end
end
