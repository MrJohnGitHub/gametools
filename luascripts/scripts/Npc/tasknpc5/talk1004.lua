...
function CreatureNpcFun1004(npc,event,player,funid)
  if funid == 2 and player:get_task_state(4) == 2 then	
		player:set_task_state(5,1);  
		player:push_task_data(5,1);
		player:add_exp(4000);
		player:add_gamemoney_bind(2000);
		return;
	end
end
