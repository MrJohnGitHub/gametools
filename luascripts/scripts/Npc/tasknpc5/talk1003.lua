...
function CreatureNpcFun1003(npc,event,player,funid)
  if funid == 2 and player:get_task_state(3) == 2 then
      player:set_task_state(4,1);  
      player:push_task_data(4,1);
      player:add_exp(2600);
      player:add_gamemoney_bind(1500);
      player:add_item(10036,1,1,0,0);
 end
