...
function CreatureNpcFun1011(npc,event,player,funid)
  if funid == 2 and player:get_task_state(11) == 2 then
      player:set_task_state(12,1);  
      player:push_task_data(12,1);
      player:add_exp(30000);
      player:add_gamemoney_bind(10000);
	    local job = player:get_job();
	    if job == 1 then
		player:add_item(21101,1,1,0,0);
	    elseif job == 2 then
		player:add_item(21122,1,1,0,0);
	    else 
		player:add_item(21143,1,1,0,0);
	    end      
      return;
  end
end
