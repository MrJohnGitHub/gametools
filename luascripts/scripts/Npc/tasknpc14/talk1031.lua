...
function CreatureNpcFun1031(npc,event,player,funid)
  if funid == 2 and player:get_task_state(31) == 2 then
      player:set_task_state(32,1);  
      player:push_task_data(32,1);
      player:add_exp(650000);
      player:add_gamemoney_bind(95000);
     return;
  end
end
